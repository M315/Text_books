%=============================================================================
%	Stocastic Calculus and Financial Applications - Michael Steele - Notes
%=============================================================================
...
\fancyhead[L]{Stochastic Calculus and Financial Applications}	% Left header
...
\begin{document}
\include{1_random_walk}
\include{2_first_martingale_steps}
\include{3_brownian_motion}
\include{4_martingales_next_steps}
\include{5_richness_of_path}
\end{document}